...
examples/gguf-split/CMakeFiles/llama-gguf-split.dir/gguf-split.cpp.o: /content/llama.cpp/examples/gguf-split/gguf-split.cpp
examples/gguf-split/CMakeFiles/llama-gguf-split.dir/gguf-split.cpp.o: examples/gguf-split/CMakeFiles/llama-gguf-split.dir/compiler_depend.ts
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --progress-dir=/content/llama.cpp/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object examples/gguf-split/CMakeFiles/llama-gguf-split.dir/gguf-split.cpp.o"
	cd /content/llama.cpp/build/examples/gguf-split && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -MD -MT examples/gguf-split/CMakeFiles/llama-gguf-split.dir/gguf-split.cpp.o -MF CMakeFiles/llama-gguf-split.dir/gguf-split.cpp.o.d -o CMakeFiles/llama-gguf-split.dir/gguf-split.cpp.o -c /content/llama.cpp/examples/gguf-split/gguf-split.cpp
...
examples/gguf-split/CMakeFiles/llama-gguf-split.dir/gguf-split.cpp.i: cmake_force
	...
	cd /content/llama.cpp/build/examples/gguf-split && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /content/llama.cpp/examples/gguf-split/gguf-split.cpp > CMakeFiles/llama-gguf-split.dir/gguf-split.cpp.i
...
examples/gguf-split/CMakeFiles/llama-gguf-split.dir/gguf-split.cpp.s: cmake_force
	...
	cd /content/llama.cpp/build/examples/gguf-split && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /content/llama.cpp/examples/gguf-split/gguf-split.cpp -o CMakeFiles/llama-gguf-split.dir/gguf-split.cpp.s
...
bin/llama-gguf-split: src/libllama.so
bin/llama-gguf-split: ggml/src/libggml.so
bin/llama-gguf-split: ggml/src/libggml-cpu.so
bin/llama-gguf-split: ggml/src/ggml-cuda/libggml-cuda.so
bin/llama-gguf-split: ggml/src/libggml-base.so
...
bin/llama-gguf-split: examples/gguf-split/CMakeFiles/llama-gguf-split.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --green --bold --progress-dir=/content/llama.cpp/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/llama-gguf-split"
	cd /content/llama.cpp/build/examples/gguf-split && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/llama-gguf-split.dir/link.txt --verbose=$(VERBOSE)
...
examples/gguf-split/CMakeFiles/llama-gguf-split.dir/clean:
	cd /content/llama.cpp/build/examples/gguf-split && $(CMAKE_COMMAND) -P CMakeFiles/llama-gguf-split.dir/cmake_clean.cmake
...
examples/gguf-split/CMakeFiles/llama-gguf-split.dir/depend:
	cd /content/llama.cpp/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /content/llama.cpp /content/llama.cpp/examples/gguf-split /content/llama.cpp/build /content/llama.cpp/build/examples/gguf-split /content/llama.cpp/build/examples/gguf-split/CMakeFiles/llama-gguf-split.dir/DependInfo.cmake "--color=$(COLOR)"
